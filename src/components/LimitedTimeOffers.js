    ...
    <section className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6 border-b border-zinc-100 pb-4">
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center gap-2 w-fit px-3 py-1 rounded-full bg-rose-500/10 text-rose-700 border border-rose-500/20 text-xs font-black uppercase tracking-wider">
            <Clock size={13} className="text-rose-600 animate-pulse" />
            <span>{isAr ? "عروض لفترة محدودة" : "Limited Time Deals"}</span>
          </div>
