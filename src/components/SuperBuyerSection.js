            ...
            <div className="lg:col-span-2 bg-white border border-zinc-200 rounded-lg overflow-hidden shadow-sm flex flex-col">
             ...
             <div className="bg-gradient-to-br from-brand to-brand-dark border border-brand-dark rounded-lg overflow-hidden shadow-sm relative text-white flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col relative z-10">
                   {finalStore ? (
                      <>
                         <div className="w-20 h-20 bg-white rounded-full mx-auto mb-4 p-1 shadow-lg flex items-center justify-center overflow-hidden border-2 border-[#be374f]">
                         ...
                         <div className="mt-auto w-full">
                            <Link href={`/vendors/${finalStore.id}`} className="w-full py-3 bg-white hover:bg-brand-light text-brand font-bold rounded-full flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.98]">
                      ...
                      <div className="flex-1 flex flex-col items-center justify-center text-center">
                         ...
                         <Link href="/merchant" className="w-full py-3 bg-white hover:bg-brand-light text-brand font-bold rounded-full flex items-center justify-center transition-all shadow-md active:scale-[0.98]">
                            {t("learnMore")}
                         </Link>
                      </div>
                   )}
