         ...
         <div className="max-w-[1200px] mx-auto px-4 lg:px-8 flex flex-col md:flex-row justify-between gap-12 md:gap-4">
            ...
            <div className="flex flex-col w-full md:w-1/2">
               ...
               <ul className="flex items-center gap-3 text-white">
                  ...
                  <li>
                     <a href={settings?.socialYoutube || "#"} target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-brand hover:bg-brand-dark flex items-center justify-center transition-colors">
                        <YoutubeIcon />
                     </a>
                  </li>
                  <li>
