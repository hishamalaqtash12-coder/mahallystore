  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6] font-sans pb-24">
      ...
      <div className="max-w-[800px] mx-auto px-4 mt-[-20px] relative z-10">
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-zinc-200 mb-8 border-l-4 border-l-[#FFD814]">
           <div className="flex items-start gap-4 mb-4">
              <ShieldCheck size={28} className="text-[#FFD814] shrink-0 mt-1" />
              <div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-zinc-200 mb-8">
           ...
           <ul className="space-y-4 text-zinc-600">
              <li className="flex items-start gap-3">
                 <span className="text-[#007185] mt-1">•</span>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-zinc-200 mb-8">
           <div className="flex items-center gap-3 mb-6 pb-4 border-b border-zinc-100">
              <div className="p-2 bg-orange-50 text-orange-600 rounded-lg"><Store size={24} /></div>
