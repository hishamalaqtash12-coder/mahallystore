    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="bg-[#f8f8f8]">
        <div className="h-10 flex items-center gap-1.5 text-[12px] text-[#565959] max-w-[1200px] mx-auto px-4 lg:px-6 w-full">
          <Link href="/" className="hover:text-[#007185] hover:underline transition-colors">الرئيسية</Link>
          <span className="text-zinc-400">›</span>
          {product.categories?.[0] && (
            <>
              <Link href={`/browse?cat=${product.categories[0].slug}`} className="hover:text-[#007185] hover:underline transition-colors" dangerouslySetInnerHTML={{ __html: product.categories[0].name }} />
              <span className="text-zinc-400">›</span>
            </>
          )}
          ...
          <div className="flex flex-col bg-white p-6 rounded-xl border border-zinc-200 lg:bg-transparent lg:p-0 lg:border-none">
            ...
            <div className="mb-3 border-b border-zinc-200 pb-3">
              ...
              {(() => {
                ...
                return (
                  <Link
                    ...
                    className="text-[14px] text-[#007185] hover:text-[#9b2c41] hover:underline mb-2 inline-block"
                  >
              ...
              <div className="flex flex-wrap items-center gap-4 text-[14px]">
                <div className="flex items-center gap-1">
                  ...
                  <a href="#" className="text-[#007185] hover:text-[#9b2c41] hover:underline ml-2">{ratingCount.toLocaleString()} تقييمات</a>
                </div>
                {soldCount > 0 && (
            ...
            <div className="mb-4">
              <div className="flex flex-wrap items-center gap-2 mb-2">
                {discount > 0 && (
                  <div className="inline-block bg-[#CC0C39] text-white text-[12px] font-bold px-2 py-1 rounded-sm">
                    عرض لفترة محدودة
                  </div>
                )}
              ...
              <div className="flex items-start gap-2">
                {discount > 0 && (
                  <span className="text-[28px] text-[#CC0C39] font-light leading-none">-{discount}%</span>
                )}
            ...
            <div className="grid grid-cols-[120px_1fr] gap-y-2 text-[14px] mb-6">
              ...
              <div className="text-[#0F1111] font-bold text-orange-600 bg-orange-50 px-2 py-0.5 rounded border border-orange-100 inline-block w-fit">
                {(() => {
                  const { name: storeName, id: storeId } = getProductMerchant(product);
