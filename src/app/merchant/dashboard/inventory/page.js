        ...
        <div className="flex items-center gap-2">
           ...
           <div className="relative">
             ...
             <input 
               ...
               className="pl-9 pr-4 py-2 border border-zinc-200 rounded-md text-sm outline-none focus:border-orange-400 w-64"
             />
           </div>
        </div>
      </div>
                ...
                <tr key={product.id} className="hover:bg-zinc-50/50 transition-colors group">
                  <td className="px-6 py-4">
                    <div className="flex flex-col">
                      <span className="text-sm font-bold text-zinc-900 group-hover:text-orange-600 transition-colors truncate max-w-[200px]">
                        {product.name}
                      </span>
                    ...
                    <div className="flex flex-col">
                      <div className="flex items-center gap-3">
                        ...
                        <button 
                          ...
                          className="p-1.5 bg-zinc-100 hover:bg-orange-100 hover:text-orange-600 rounded-md transition-all text-zinc-500"
                 ...
                 <div className="space-y-4">
                    <div className="relative">
                       ...
                       <input 
                         ...
                         className="w-full px-4 py-3 bg-zinc-50 border border-zinc-200 rounded-lg text-lg font-bold outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400 transition-all"
                         autoFocus
                       />
                    </div>
