    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="bg-[#FFD814] hover:bg-[#F7CA00] border border-[#FCD200] px-6 py-2 rounded-md font-bold text-sm shadow-sm flex items-center gap-2 transition-all disabled:opacity-50"
        >
                ...
                <td className="px-6 py-4">
                  <div className="relative w-32">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-3 py-2 border border-zinc-200 rounded-md text-sm focus:border-orange-400 outline-none transition-all"
                    />
                  </div>
                </td>
                <td className="px-6 py-4">
