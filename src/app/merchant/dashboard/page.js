      ...
      return (
        <div className="h-[400px] flex flex-col items-center justify-center p-8 text-center bg-white border border-zinc-200 rounded-md shadow-sm">
          ...
          <button
            ...
            className="h-10 px-8 bg-[#FFD814] hover:bg-[#F7CA00] text-zinc-900 rounded-md font-bold transition-all shadow-md"
          >
            Retry Sync
          </button>
        </div>
            ...
            {stats.map((stat, i) => (
              <div key={i} className="bg-white border border-zinc-200 p-5 rounded-md hover:shadow-md transition-all group relative">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <stat.icon size={18} className="text-zinc-300 group-hover:text-[#e77600] transition-colors" />
                </div>
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-[34px] bg-white border border-zinc-300 rounded-md pl-9 pr-3 text-[13px] outline-none focus:border-[#e77600] transition-all w-64 shadow-sm"
                  />
                </div>
                <button
                  ...
                  {filteredOrders.length > 0 ? filteredOrders.map((order) => (
                    <tr key={order.id} className="hover:bg-zinc-50 transition-colors cursor-pointer group">
                      <td className="px-6 py-4">
                        <span className="text-[13px] font-bold text-[#007185] group-hover:text-[#c45500]">#ORD-{order.id}</span>
                      </td>
                      <td className="px-6 py-4">
