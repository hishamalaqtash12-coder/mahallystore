                ...
                refunds.map((r) => (
                  <tr key={r.id} className="hover:bg-zinc-50 transition-colors group">
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[12px] text-[#007185] font-medium group-hover:text-[#c45500]">Order #{r.order_id}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5 text-right">
                      <button className="text-[13px] text-[#007185] font-bold hover:underline">View Details</button>
                    </td>
                  </tr>
                ))
              ) : (
