      ...
      <div className="container mx-auto px-4 mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full h-11 bg-white border border-zinc-300 rounded-md px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#007185] focus:border-transparent transition-all" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-zinc-800">Email Address</label>
                  <input type="email" className="w-full h-11 bg-white border border-zinc-300 rounded-md px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#007185] focus:border-transparent transition-all" placeholder="john@example.com" />
                </div>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-zinc-800">Subject</label>
                <input type="text" className="w-full h-11 bg-white border border-zinc-300 rounded-md px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#007185] focus:border-transparent transition-all" placeholder="How can we help?" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-zinc-800">Message</label>
                <textarea className="w-full h-32 bg-white border border-zinc-300 rounded-md p-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#007185] focus:border-transparent transition-all resize-none" placeholder="Write your message here..."></textarea>
              </div>
              <button className="h-11 bg-[#FFD814] hover:bg-[#F7CA00] text-zinc-900 w-full md:w-auto px-8 rounded-full font-bold text-sm shadow-sm transition-all flex items-center justify-center gap-2">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-50 rounded-xl p-6 border border-zinc-200">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-white border border-zinc-200 flex items-center justify-center text-[#007185] shrink-0 shadow-sm">
                    <Phone size={18} />
                  </div>
                  <div>
            ...
            <div className="bg-[#232F3E] rounded-xl p-6 text-white text-center">
