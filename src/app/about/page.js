...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <section className="relative h-[500px] flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto text-center px-4">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight leading-tight">
            Empowering Local <span className="text-[#FFD814]">Communities</span>
          </h1>
      ...
      <section className="py-24 px-4 max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#007185]/10 text-[#007185] rounded-full text-sm font-bold uppercase tracking-wider">
              <Globe size={16} />
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-zinc-50 p-8 rounded-2xl border border-zinc-100 flex flex-col items-center text-center">
              <Truck size={40} className="text-[#007185] mb-4" />
      ...
      <section className="bg-[#232f3e] py-24 text-white">
        <div className="max-w-[1280px] mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-10 rounded-2xl border border-white/10 hover:border-[#FFD814]/30 transition-all group">
              <div className="w-14 h-14 bg-[#FFD814] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Zap size={28} className="text-zinc-900" />
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-10 rounded-2xl border border-white/10 hover:border-[#FFD814]/30 transition-all group">
              <div className="w-14 h-14 bg-[#FFD814] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Truck size={28} className="text-zinc-900" />
              </div>
      ...
      <section className="py-24 px-4 max-w-[1280px] mx-auto text-center">
        <div className="bg-zinc-50 rounded-[32px] p-12 md:p-20 border border-zinc-100">
          <Heart size={64} className="text-[#B12704] mx-auto mb-8 animate-pulse" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/browse" className="w-full sm:w-auto h-[52px] px-10 bg-[#FFD814] hover:bg-[#F7CA00] text-zinc-900 rounded-full flex items-center justify-center font-bold text-lg shadow-sm transition-all">
              Browse Products
            </Link>
