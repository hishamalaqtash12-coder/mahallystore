        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-zinc-200 shadow-sm">
          <div>
            <h1 className="text-2xl font-bold text-zinc-900 flex items-center gap-2">
              <Megaphone size={24} className="text-[#007185]" />
           ...
           <form onSubmit={handleManualPromote} className="flex flex-col md:flex-row items-end gap-4">
              <div className="space-y-1 w-full md:w-auto flex-1">
                 ...
                 <select 
                    ...
                    className="w-full h-10 px-3 rounded-lg border border-zinc-300 text-[13px] outline-none focus:border-[#007185]"
                 >
              ...
              <button 
                 ...
                 className="h-10 px-6 bg-[#FFD814] hover:bg-[#F7CA00] text-zinc-900 font-bold rounded-lg shadow-sm text-[13px] transition-all disabled:opacity-50 whitespace-nowrap"
              >
                     ...
                     return (
                       <tr key={`${ad.type}-${ad.id}-${idx}`} className="hover:bg-zinc-50 transition-colors">
                         <td className="px-6 py-4">
                           <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-bold capitalize ${ad.type === 'product' ? 'bg-[#e8f4f5] text-[#007185]' : 'bg-[#fffaf5] text-[#e77600]'}`}>
                             {ad.type}
                           </span>
                         </td>
                         <td className="px-6 py-4">
                ...
                <tbody className="divide-y divide-zinc-100">
                  {requests.map((req) => (
                    <tr key={req.id} className="hover:bg-zinc-50 transition-colors group">
                      <td className="px-6 py-4">
                        <p className="text-[13px] font-bold text-[#007185]">#{req.id}</p>
                        ...
                        {req.status === "processing" ? (
                          <div className="flex justify-end gap-2">
                            <button
                              ...
                              className="px-4 py-1.5 bg-[#007185] hover:bg-[#005a6a] text-white text-[12px] font-bold rounded shadow-sm disabled:opacity-50"
                            >
